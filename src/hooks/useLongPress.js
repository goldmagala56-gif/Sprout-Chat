...
// Fires onLongPress after holding for LONG_PRESS_MS (mouse or touch), and
// suppresses the ordinary click/tap that follows a long-press so it doesn't
// also trigger onClick. A normal, quick tap still calls onClick as usual.
